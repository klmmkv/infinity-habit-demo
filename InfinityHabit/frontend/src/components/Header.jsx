    ...
    <header className="body-font mx-auto max-w-7xl p-4 text-gray-600">
      <div className="container mx-auto flex flex-col flex-wrap items-center gap-4 p-5 md:flex-row lg:gap-0">
        <a className="title-font flex items-center font-medium text-gray-900 md:mb-0">
          <img src="https://cdn-icons-png.flaticon.com/512/5778/5778476.png" className="h-12" />
          <span className="ml-3 text-xl">Infinity Habits</span>
        </a>
        <nav className="flex flex-wrap items-center justify-center text-base md:mr-auto	md:ml-4 md:border-l md:border-gray-400 md:py-1 md:pl-4">
          ...
          <Link href="/rewards/viewrewards">
            <a className="mr-5 hover:text-gray-900">My Awards</a>
          </Link>
          <Link href="/metrics/0/viewenrollments">
            <a className="mr-5 hover:text-gray-900">My Challenges</a>
          </Link>
          <Link href ="/">
            <a className="mr-5 hover:text-gray-900">Setup Hera</a>
          </Link>
          <Link href = "/">
            <a className="mr-5 hover:text-gray-900">Set Badge Rules</a>
        </Link>
          <Link href = "/">
            <a className="mr-5 hover:text-gray-900">Mint Badges</a>
        </Link>
        </nav>
        {!isMetamaskConnected && (
          <button
